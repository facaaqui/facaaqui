...
<script>
            ...
            function changeStatusMerc(sessao,status) {
                    xhr = new XMLHttpRequest();
                    url = "../../controllerGateway.php?controller=Pedidos&method=changeStatusMer&field[Pedidos.id]="+sessao+"&field[Pedidos.status]="+status;
                    xhr.open("GET", url, true);
                    xhr.onreadystatechange = function () {
                        if (xhr.readyState == 4) {
                            alert(xhr.responseText);
                            document.getElementById('btnPronto'+sessao).style.display = 'none';
                            document.getElementById('inputToken'+sessao).style.display = '';
                        }
                    }
                    xhr.send();
            ...
            function itensPedido(idPedido) {
//                alert(numOrdem);
                    xhr = new XMLHttpRequest();
                    url = "../../controllerGateway.php?controller=ConsulVision&method=prodByPedido&field[ItensPedido.idPedido]="+idPedido;
                    xhr.open("GET", url, true);
                    xhr.onreadystatechange = function () {
                        if (xhr.readyState == 4) {
//                            alert(xhr.responseText);
