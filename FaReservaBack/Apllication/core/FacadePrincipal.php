...
class FacadePrincipal {
    ...
    public function mercadoController(){
        return new MercadoController();
    }
    
    public function pedidosDTO(){
        return new PedidosDTO();
    }

    public function prodImgController(){
        return new ProdImagemController();
    }
    
    public function colaboradorDTO(){
